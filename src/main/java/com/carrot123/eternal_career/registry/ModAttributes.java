...
public final class ModAttributes {
    ...
    public static final RegistryObject<Attribute> KITCHENWARE_DAMAGE =
            ATTRIBUTES.register(
                    "kitchenware_damage",
                    () -> new RangedAttribute(
    ...
    public static final RegistryObject<Attribute> NON_KITCHENWARE_DAMAGE =
            ATTRIBUTES.register(
    ...
    public static final RegistryObject<Attribute> SCYTHE_DAMAGE =
            ATTRIBUTES.register(
                    "scythe_damage",
                    () -> new RangedAttribute(
                            "attribute.eternal_career.scythe_damage",
                            DEFAULT_DAMAGE_MULTIPLIER,
                            MIN_DAMAGE_MULTIPLIER,
                            MAX_DAMAGE_MULTIPLIER
                    ).setSyncable(true)
    ...
    public static final RegistryObject<Attribute> NON_SCYTHE_DAMAGE =
            ATTRIBUTES.register(
                    "non_scythe_damage",
                    () -> new RangedAttribute(
                            "attribute.eternal_career.non_scythe_damage",
                            DEFAULT_DAMAGE_MULTIPLIER,
                            MIN_DAMAGE_MULTIPLIER,
                            MAX_DAMAGE_MULTIPLIER
                    ).setSyncable(true)
    ...
    private static void addPlayerAttributes(
            EntityAttributeModificationEvent event
    ) {
        event.add(
                EntityType.PLAYER,
                KITCHENWARE_DAMAGE.get()
        );

        event.add(
                EntityType.PLAYER,
                NON_KITCHENWARE_DAMAGE.get()
        );
