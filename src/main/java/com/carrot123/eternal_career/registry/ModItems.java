...
public final class ModItems {
    ...
    public static final RegistryObject<Item> NECROMANCY_ORB_FOCUS =
            ITEMS.register(
                    "necromancy_orb_focus",
                    () -> new MagicFocus(
    ...
    public static final RegistryObject<Item> CHAOS_STEAK =
            ITEMS.register(
                    "chaos_steak",
                    () -> new ChaosFoodItem(
                            new Item.Properties()
    ...
    public static final RegistryObject<Item> CHAOS_BLADE =
            ITEMS.register(
                    "chaos_blade",
                    () -> new ChaosBladeItem(
                            new Item.Properties()
